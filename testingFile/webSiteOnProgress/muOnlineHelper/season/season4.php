<?php include'../core/header.php'?>
		...
		<div class="title">MU-ONLINE SEASON 4</div>
		
		<center><h5>MU-ONLINE SEASON 4 have new map Rackleon (La Cleon) / mew Racleon Event / Socket Items / Socket System Sphere / PvP Duel Map</h5></center>
		...
		<label class="sst" for="maps97">MU-ONLINE SEASON 4 ALL MAPS</label>
		<ul class="submenu">
			<center>
				<table>
					<tr>
