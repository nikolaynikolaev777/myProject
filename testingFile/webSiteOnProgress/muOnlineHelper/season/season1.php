<?php include'../core/header.php'?>
		...
		<div class="title">MU-ONLINE SEASON 1</div>
		
		<center><h5>MU-ONLINE SEASON 1 have new map - Crywolf / new event Crywolf Forest / new Ancient Set Item / 
		Fenrir pet / Lahap stack jewels</h5></center>
		...
		<label class="sst" for="maps97">MU-ONLINE SEASON 1 ALL MAPS</label>
		<ul class="submenu">
			<center>
				<table>
					<tr>
