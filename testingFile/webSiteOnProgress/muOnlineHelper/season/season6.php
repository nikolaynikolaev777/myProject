<?php include'../core/header.php'?>
		...
		<div class="title">MU-ONLINE SEASON 6</div>
		
		<center><h5>MU-ONLINE SEASON 6 have new map Karutan / Character Rage Fighter / Small wings / Inventory and Vault extensions / Official MU Helper / Monster Health bar / Additional jewels can be (un)packed by Lahap</h5></center>
		...
		<label class="sst" for="maps97">MU-ONLINE SEASON 6 ALL MAPS</label>
		<ul class="submenu">
			<center>
				<table>
					<tr>
