<?php include'../core/header.php'?>
		...
		<div class="title">MU-ONLINE SEASON 5</div>
		
		<center><h5>MU-ONLINE SEASON 5 have new event Fortress Imperial Event, Doppelganger Event / Gens System / +15 Item / Quests from Elf Soldier</h5></center>
		...
		<label class="sst" for="maps97">MU-ONLINE SEASON 5 ALL MAPS</label>
		<ul class="submenu">
			<center>
				<table>
					<tr>
