<?php include'../core/header.php'?>
		...
		<div class="title">MU-ONLINE SEASON 2</div>
		
		<center><h5>MU-ONLINE SEASON 2 have new map - Kanturo, Aida / New Event / New Jewel - Gem Stone, Jewel of Harmony / SD bar for PvP and SD potion / New 380lvl Items</h5></center>
		...
		<label class="sst" for="maps97">MU-ONLINE SEASON 2 ALL MAPS</label>
		<ul class="submenu">
			<center>
				<table>
					<tr>
