<?php include'../core/header.php'?>
		...
		<div class="title">MU-ONLINE SEASON 3</div>
		
		<center><h5>MU-ONLINE SEASON 3 have new map Elbeland, Barracks, Refuge, Swamp of Calmess, Santa Village / New Event Castle Siege / New Character Summoner / 3 Level Quest, 
		Master class Tree / new 3 Level Wing / Golden Fenrir / new Ancient Items</h5></center>
		...
		<label class="sst" for="maps97">MU-ONLINE SEASON 3 ALL MAPS</label>
		<ul class="submenu">
			<center>
				<table>
					<tr>
