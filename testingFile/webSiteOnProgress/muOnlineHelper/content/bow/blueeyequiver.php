<label class="popbox-BG" for="blueeyequiver"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="blueeyequiver"></label>
	<center><p>Blue Eye Quiver</p></center>
	<div class="content">
		<input id="stat-blueeyequiver" type="checkbox" name="menu" />
		<label class="sst" for="stat-blueeyequiver">SHOW ITEM STAT</label>
		<ul class="submenu">
