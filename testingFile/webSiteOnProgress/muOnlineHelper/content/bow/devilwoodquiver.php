<label class="popbox-BG" for="devilwoodquiver"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="devilwoodquiver"></label>
	<center><p>Devilwood Quiver</p></center>
	<div class="content">
		<input id="stat-devilwoodquiver" type="checkbox" name="menu" />
		<label class="sst" for="stat-devilwoodquiver">SHOW ITEM STAT</label>
		<ul class="submenu">
