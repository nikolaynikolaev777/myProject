<label class="popbox-BG" for="quiverbow"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="quiverbow"></label>
	<center><p>Quiver Bow</p></center>
	<div class="content">
		<input id="stat-quiverbow" type="checkbox" name="menu" />
		<label class="sst" for="stat-quiverbow">SHOW ITEM STAT</label>
		<ul class="submenu">
