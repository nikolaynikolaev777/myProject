<label class="popbox-BG" for="soulquiver"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="soulquiver"></label>
	<center><p>Soul Quiver</p></center>
	<div class="content">
		<input id="stat-soulquiver" type="checkbox" name="menu" />
		<label class="sst" for="stat-soulquiver">SHOW ITEM STAT</label>
		<ul class="submenu">
