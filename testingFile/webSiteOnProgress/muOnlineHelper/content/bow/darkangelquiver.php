<label class="popbox-BG" for="darkangelquiver"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="darkangelquiver"></label>
	<center><p>Darkangel Quiver</p></center>
	<div class="content">
		<input id="stat-darkangelquiver" type="checkbox" name="menu" />
		<label class="sst" for="stat-darkangelquiver">SHOW ITEM STAT</label>
		<ul class="submenu">
