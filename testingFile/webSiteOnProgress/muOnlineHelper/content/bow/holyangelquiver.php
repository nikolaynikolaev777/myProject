<label class="popbox-BG" for="holyangelquiver"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="holyangelquiver"></label>
	<center><p>Holyangel Quiver</p></center>
	<div class="content">
		<input id="stat-holyangelquiver" type="checkbox" name="menu" />
		<label class="sst" for="stat-holyangelquiver">SHOW ITEM STAT</label>
		<ul class="submenu">
