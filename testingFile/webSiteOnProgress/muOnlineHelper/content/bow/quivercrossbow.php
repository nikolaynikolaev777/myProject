<label class="popbox-BG" for="quivercrossbow"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="quivercrossbow"></label>
	<center><p>Quiver Crossbow</p></center>
	<div class="content">
		<input id="stat-quivercrossbow" type="checkbox" name="menu" />
		<label class="sst" for="stat-quivercrossbow">SHOW ITEM STAT</label>
		<ul class="submenu">
