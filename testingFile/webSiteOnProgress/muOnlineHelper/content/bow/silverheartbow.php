<label class="popbox-BG" for="silverheartbow"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="silverheartbow"></label>
	<center><p>Silver Heart Bow</p></center>
	<div class="content">
		<input id="stat-silverheartbow" type="checkbox" name="menu" />
		<label class="sst" for="stat-silverheartbow">SHOW ITEM STAT</label>
		<ul class="submenu">
