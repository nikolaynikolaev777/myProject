<label class="popbox-BG" for="silverheartquiver"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="silverheartquiver"></label>
	<center><p>Silver Heart Quiver</p></center>
	<div class="content">
		<input id="stat-silverheartquiver" type="checkbox" name="menu" />
		<label class="sst" for="stat-silverheartquiver">SHOW ITEM STAT</label>
		<ul class="submenu">
