<label class="popbox-BG" for="combatquiver"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="combatquiver"></label>
	<center><p>Combat Quiver</p></center>
	<div class="content">
		<input id="stat-combatquiver" type="checkbox" name="menu" />
		<label class="sst" for="stat-combatquiver">SHOW ITEM STAT</label>
		<ul class="submenu">
