<label class="popbox-BG" for="bloodangelquiver"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="bloodangelquiver"></label>
	<center><p>Bloodangel Quiver</p></center>
	<div class="content">
		<input id="stat-bloodangelquiver" type="checkbox" name="menu" />
		<label class="sst" for="stat-bloodangelquiver">SHOW ITEM STAT</label>
		<ul class="submenu">
