<label class="popbox-BG" for="silverheartmagicgun"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="silverheartmagicgun"></label>
	<center><p>Silver Heart Magic Gun</p></center>
	<div class="content">
		<input id="stat-silverheartmagicgun" type="checkbox" name="menu" />
		<label class="sst" for="stat-silverheartmagicgun">SHOW ITEM STAT</label>
		<ul class="submenu">
