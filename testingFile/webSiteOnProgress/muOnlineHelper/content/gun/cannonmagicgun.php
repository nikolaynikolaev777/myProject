<label class="popbox-BG" for="cannonmagicgun"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="cannonmagicgun"></label>
	<center><p>Cannon Magic Gun</p></center>
	<div class="content">
		<input id="stat-cannonmagicgun" type="checkbox" name="menu" />
		<label class="sst" for="stat-cannonmagicgun">SHOW ITEM STAT</label>
		<ul class="submenu">
