<label class="popbox-BG" for="holyangelmagicgun"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="holyangelmagicgun"></label>
	<center><p>Holyangel Magic Gun</p></center>
	<div class="content">
		<input id="stat-holyangelmagicgun" type="checkbox" name="menu" />
		<label class="sst" for="stat-holyangelmagicgun">SHOW ITEM STAT</label>
		<ul class="submenu">
