<label class="popbox-BG" for="blessdivinemagicgunofthearchangel"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="blessdivinemagicgunofthearchangel"></label>
	<center><p>Bless Divine Magic Gun of the Archangel</p></center>
	<div class="content">
		<input id="stat-blessdivinemagicgunofthearchangel" type="checkbox" name="menu" />
		<label class="sst" for="stat-blessdivinemagicgunofthearchangel">SHOW ITEM STAT</label>
		<ul class="submenu">
