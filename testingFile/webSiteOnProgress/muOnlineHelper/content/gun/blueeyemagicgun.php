<label class="popbox-BG" for="blueeyemagicgun"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="blueeyemagicgun"></label>
	<center><p>Blue Eye Magic Gun</p></center>
	<div class="content">
		<input id="stat-blueeyemagicgun" type="checkbox" name="menu" />
		<label class="sst" for="stat-blueeyemagicgun">SHOW ITEM STAT</label>
		<ul class="submenu">
