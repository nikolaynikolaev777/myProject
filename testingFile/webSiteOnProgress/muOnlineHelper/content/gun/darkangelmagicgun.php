<label class="popbox-BG" for="darkangelmagicgun"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="darkangelmagicgun"></label>
	<center><p>Darkangel Magic Gun</p></center>
	<div class="content">
		<input id="stat-darkangelmagicgun" type="checkbox" name="menu" />
		<label class="sst" for="stat-darkangelmagicgun">SHOW ITEM STAT</label>
		<ul class="submenu">
