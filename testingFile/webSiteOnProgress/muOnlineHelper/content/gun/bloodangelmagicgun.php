<label class="popbox-BG" for="bloodangelmagicgun"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="bloodangelmagicgun"></label>
	<center><p>Bloodangel Magic Gun</p></center>
	<div class="content">
		<input id="stat-bloodangelmagicgun" type="checkbox" name="menu" />
		<label class="sst" for="stat-bloodangelmagicgun">SHOW ITEM STAT</label>
		<ul class="submenu">
