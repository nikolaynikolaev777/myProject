<label class="popbox-BG" for="magicgunofthearchangel"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="magicgunofthearchangel"></label>
	<center><p>Magic Gun of the Archangel</p></center>
	<div class="content">
		<input id="stat-magicgunofthearchangel" type="checkbox" name="menu" />
		<label class="sst" for="stat-magicgunofthearchangel">SHOW ITEM STAT</label>
		<ul class="submenu">
