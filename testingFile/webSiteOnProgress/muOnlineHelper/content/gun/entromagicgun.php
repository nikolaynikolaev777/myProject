<label class="popbox-BG" for="entromagicgun"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="entromagicgun"></label>
	<center><p>Entro Magic Gun</p></center>
	<div class="content">
		<input id="stat-entromagicgun" type="checkbox" name="menu" />
		<label class="sst" for="stat-entromagicgun">SHOW ITEM STAT</label>
		<ul class="submenu">
