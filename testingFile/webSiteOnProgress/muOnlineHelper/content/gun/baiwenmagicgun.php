<label class="popbox-BG" for="baiwenmagicgun"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="baiwenmagicgun"></label>
	<center><p>Baiwen Magic Gun</p></center>
	<div class="content">
		<input id="stat-baiwenmagicgun" type="checkbox" name="menu" />
		<label class="sst" for="stat-baiwenmagicgun">SHOW ITEM STAT</label>
		<ul class="submenu">
