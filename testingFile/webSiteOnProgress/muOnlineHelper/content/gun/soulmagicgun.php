<label class="popbox-BG" for="soulmagicgun"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="soulmagicgun"></label>
	<center><p>Soul Magic Gun</p></center>
	<div class="content">
		<input id="stat-soulmagicgun" type="checkbox" name="menu" />
		<label class="sst" for="stat-soulmagicgun">SHOW ITEM STAT</label>
		<ul class="submenu">
