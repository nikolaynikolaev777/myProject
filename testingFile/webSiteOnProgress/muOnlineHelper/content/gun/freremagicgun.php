<label class="popbox-BG" for="freremagicgun"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="freremagicgun"></label>
	<center><p>Frere Magic Gun</p></center>
	<div class="content">
		<input id="stat-freremagicgun" type="checkbox" name="menu" />
		<label class="sst" for="stat-freremagicgun">SHOW ITEM STAT</label>
		<ul class="submenu">
