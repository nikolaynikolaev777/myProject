<label class="popbox-BG" for="lapidshield"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="lapidshield"></label>
	<center><p>Lapid Shield</p></center>
	<div class="content">
		<input id="stat-lapidshield" type="checkbox" name="menu" />
		<label class="sst" for="stat-lapidshield">SHOW ITEM STAT</label>
		<ul class="submenu">
