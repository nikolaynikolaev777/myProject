<label class="popbox-BG" for="darkdevil"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="darkdevil"></label>
	<center><p>Dark Devil</p></center>
	<div class="content">
		<input id="stat-darkdevil" type="checkbox" name="menu" />
		<label class="sst" for="stat-darkdevil">SHOW ITEM STAT</label>
		<ul class="submenu">
