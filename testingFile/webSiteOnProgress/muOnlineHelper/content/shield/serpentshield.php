<label class="popbox-BG" for="serpentshield"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="serpentshield"></label>
	<center><p>Serpent Shield</p></center>
	<div class="content">
		<input id="stat-serpentshield" type="checkbox" name="menu" />
		<label class="sst" for="stat-serpentshield">SHOW ITEM STAT</label>
		<ul class="submenu">
