<label class="popbox-BG" for="hornshield"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="hornshield"></label>
	<center><p>Horn Shield</p></center>
	<div class="content">
		<input id="stat-hornshield" type="checkbox" name="menu" />
		<label class="sst" for="stat-hornshield">SHOW ITEM STAT</label>
		<ul class="submenu">
