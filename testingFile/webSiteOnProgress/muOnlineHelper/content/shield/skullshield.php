<label class="popbox-BG" for="skullshield"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="skullshield"></label>
	<center><p>Skull Shield</p></center>
	<div class="content">
		<input id="stat-skullshield" type="checkbox" name="menu" />
		<label class="sst" for="stat-skullshield">SHOW ITEM STAT</label>
		<ul class="submenu">
