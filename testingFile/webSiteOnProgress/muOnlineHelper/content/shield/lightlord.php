<label class="popbox-BG" for="lightlord"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="lightlord"></label>
	<center><p>Light Lord</p></center>
	<div class="content">
		<input id="stat-lightlord" type="checkbox" name="menu" />
		<label class="sst" for="stat-lightlord">SHOW ITEM STAT</label>
		<ul class="submenu">
