<label class="popbox-BG" for="buckler"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="buckler"></label>
	<center><p>Buckler</p></center>
	<div class="content">
		<input id="stat-buckler" type="checkbox" name="menu" />
		<label class="sst" for="stat-buckler">SHOW ITEM STAT</label>
		<ul class="submenu">
