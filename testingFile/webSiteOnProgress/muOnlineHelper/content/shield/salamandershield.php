<label class="popbox-BG" for="salamandershield"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="salamandershield"></label>
	<center><p>Salamander Shield</p></center>
	<div class="content">
		<input id="stat-salamandershield" type="checkbox" name="menu" />
		<label class="sst" for="stat-salamandershield">SHOW ITEM STAT</label>
		<ul class="submenu">
