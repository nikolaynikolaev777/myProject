<label class="popbox-BG" for="ambition"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="ambition"></label>
	<center><p>Ambition</p></center>
	<div class="content">
		<input id="stat-ambition" type="checkbox" name="menu" />
		<label class="sst" for="stat-ambition">SHOW ITEM STAT</label>
		<ul class="submenu">
