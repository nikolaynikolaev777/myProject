<label class="popbox-BG" for="elhazard"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="elhazard"></label>
	<center><p>El Hazard</p></center>
	<div class="content">
		<input id="stat-elhazard" type="checkbox" name="menu" />
		<label class="sst" for="stat-elhazard">SHOW ITEM STAT</label>
		<ul class="submenu">
