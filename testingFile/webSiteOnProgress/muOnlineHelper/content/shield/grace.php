<label class="popbox-BG" for="grace"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="grace"></label>
	<center><p>Grace</p></center>
	<div class="content">
		<input id="stat-grace" type="checkbox" name="menu" />
		<label class="sst" for="stat-grace">SHOW ITEM STAT</label>
		<ul class="submenu">
