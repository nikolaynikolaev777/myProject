<label class="popbox-BG" for="legendaryshield"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="legendaryshield"></label>
	<center><p>Legendary Shield</p></center>
	<div class="content">
		<input id="stat-legendaryshield" type="checkbox" name="menu" />
		<label class="sst" for="stat-legendaryshield">SHOW ITEM STAT</label>
		<ul class="submenu">
