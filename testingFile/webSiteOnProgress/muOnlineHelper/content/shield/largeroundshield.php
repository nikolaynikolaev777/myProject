<label class="popbox-BG" for="largeroundshield"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="largeroundshield"></label>
	<center><p>Large Round Shield</p></center>
	<div class="content">
		<input id="stat-largeroundshield" type="checkbox" name="menu" />
		<label class="sst" for="stat-largeroundshield">SHOW ITEM STAT</label>
		<ul class="submenu">
