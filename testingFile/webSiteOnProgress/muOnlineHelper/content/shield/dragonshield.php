<label class="popbox-BG" for="dragonshield"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="dragonshield"></label>
	<center><p>Dragon Shield</p></center>
	<div class="content">
		<input id="stat-dragonshield" type="checkbox" name="menu" />
		<label class="sst" for="stat-dragonshield">SHOW ITEM STAT</label>
		<ul class="submenu">
