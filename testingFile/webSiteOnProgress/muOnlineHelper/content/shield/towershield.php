<label class="popbox-BG" for="towershield"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="towershield"></label>
	<center><p>Tower Shield</p></center>
	<div class="content">
		<input id="stat-towershield" type="checkbox" name="menu" />
		<label class="sst" for="stat-towershield">SHOW ITEM STAT</label>
		<ul class="submenu">
