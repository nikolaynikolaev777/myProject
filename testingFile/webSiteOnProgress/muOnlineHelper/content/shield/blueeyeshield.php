<label class="popbox-BG" for="blueeyeshield"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="blueeyeshield"></label>
	<center><p>Blue Eye Shield</p></center>
	<div class="content">
		<input id="stat-blueeyeshield" type="checkbox" name="menu" />
		<label class="sst" for="stat-blueeyeshield">SHOW ITEM STAT</label>
		<ul class="submenu">
