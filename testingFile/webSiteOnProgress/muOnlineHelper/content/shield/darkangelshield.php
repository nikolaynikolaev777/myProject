<label class="popbox-BG" for="darkangelshield"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="darkangelshield"></label>
	<center><p>Darkangel Shield</p></center>
	<div class="content">
		<input id="stat-darkangelshield" type="checkbox" name="menu" />
		<label class="sst" for="stat-darkangelshield">SHOW ITEM STAT</label>
		<ul class="submenu">
