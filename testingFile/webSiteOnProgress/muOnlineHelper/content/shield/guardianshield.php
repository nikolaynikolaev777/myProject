<label class="popbox-BG" for="guardianshield"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="guardianshield"></label>
	<center><p>Guardian Shield</p></center>
	<div class="content">
		<input id="stat-guardianshield" type="checkbox" name="menu" />
		<label class="sst" for="stat-guardianshield">SHOW ITEM STAT</label>
		<ul class="submenu">
