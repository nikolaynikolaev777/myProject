<label class="popbox-BG" for="silverheartshield"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="silverheartshield"></label>
	<center><p>Silver Heart Shield</p></center>
	<div class="content">
		<input id="stat-silverheartshield" type="checkbox" name="menu" />
		<label class="sst" for="stat-silverheartshield">SHOW ITEM STAT</label>
		<ul class="submenu">
