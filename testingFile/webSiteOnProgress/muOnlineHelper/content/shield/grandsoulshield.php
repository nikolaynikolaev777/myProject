<label class="popbox-BG" for="grandsoulshield"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="grandsoulshield"></label>
	<center><p>Grand Soul Shield</p></center>
	<div class="content">
		<input id="stat-grandsoulshield" type="checkbox" name="menu" />
		<label class="sst" for="stat-grandsoulshield">SHOW ITEM STAT</label>
		<ul class="submenu">
