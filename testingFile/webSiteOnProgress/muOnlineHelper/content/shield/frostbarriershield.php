<label class="popbox-BG" for="frostbarriershield"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="frostbarriershield"></label>
	<center><p>Frost Barrier Shield</p></center>
	<div class="content">
		<input id="stat-frostbarriershield" type="checkbox" name="menu" />
		<label class="sst" for="stat-frostbarriershield">SHOW ITEM STAT</label>
		<ul class="submenu">
