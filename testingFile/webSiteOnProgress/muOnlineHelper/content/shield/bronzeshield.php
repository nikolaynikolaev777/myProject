<label class="popbox-BG" for="bronzeshield"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="bronzeshield"></label>
	<center><p>Bronze Shield</p></center>
	<div class="content">
		<input id="stat-bronzeshield" type="checkbox" name="menu" />
		<label class="sst" for="stat-bronzeshield">SHOW ITEM STAT</label>
		<ul class="submenu">
