<label class="popbox-BG" for="lazywind"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="lazywind"></label>
	<center><p>Lazy Wind</p></center>
	<div class="content">
		<input id="stat-lazywind" type="checkbox" name="menu" />
		<label class="sst" for="stat-lazywind">SHOW ITEM STAT</label>
		<ul class="submenu">
