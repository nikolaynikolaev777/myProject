<label class="popbox-BG" for="crossshield"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="crossshield"></label>
	<center><p>Cross Shield</p></center>
	<div class="content">
		<input id="stat-crossshield" type="checkbox" name="menu" />
		<label class="sst" for="stat-crossshield">SHOW ITEM STAT</label>
		<ul class="submenu">
