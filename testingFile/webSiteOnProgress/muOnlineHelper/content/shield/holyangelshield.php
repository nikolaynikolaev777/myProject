<label class="popbox-BG" for="holyangelshield"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="holyangelshield"></label>
	<center><p>Holyangel Shield</p></center>
	<div class="content">
		<input id="stat-holyangelshield" type="checkbox" name="menu" />
		<label class="sst" for="stat-holyangelshield">SHOW ITEM STAT</label>
		<ul class="submenu">
