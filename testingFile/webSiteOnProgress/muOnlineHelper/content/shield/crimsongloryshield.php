<label class="popbox-BG" for="crimsongloryshield"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="crimsongloryshield"></label>
	<center><p>Crimson Glory Shield</p></center>
	<div class="content">
		<input id="stat-crimsongloryshield" type="checkbox" name="menu" />
		<label class="sst" for="stat-crimsongloryshield">SHOW ITEM STAT</label>
		<ul class="submenu">
