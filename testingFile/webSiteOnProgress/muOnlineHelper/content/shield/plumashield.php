<label class="popbox-BG" for="plumashield"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="plumashield"></label>
	<center><p>Pluma Shield</p></center>
	<div class="content">
		<input id="stat-plumashield" type="checkbox" name="menu" />
		<label class="sst" for="stat-plumashield">SHOW ITEM STAT</label>
		<ul class="submenu">
