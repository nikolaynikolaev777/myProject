<label class="popbox-BG" for="constant"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="constant"></label>
	<center><p>Constant</p></center>
	<div class="content">
		<input id="stat-constant" type="checkbox" name="menu" />
		<label class="sst" for="stat-constant">SHOW ITEM STAT</label>
		<ul class="submenu">
