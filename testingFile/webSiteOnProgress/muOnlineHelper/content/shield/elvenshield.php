<label class="popbox-BG" for="elvenshield"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="elvenshield"></label>
	<center><p>Elven Shield</p></center>
	<div class="content">
		<input id="stat-elvenshield" type="checkbox" name="menu" />
		<label class="sst" for="stat-elvenshield">SHOW ITEM STAT</label>
		<ul class="submenu">
