<label class="popbox-BG" for="visshield"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="visshield"></label>
	<center><p>Vis Shield</p></center>
	<div class="content">
		<input id="stat-visshield" type="checkbox" name="menu" />
		<label class="sst" for="stat-visshield">SHOW ITEM STAT</label>
		<ul class="submenu">
