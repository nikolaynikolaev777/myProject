<label class="popbox-BG" for="smallshield"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="smallshield"></label>
	<center><p>Small Shield</p></center>
	<div class="content">
		<input id="stat-smallshield" type="checkbox" name="menu" />
		<label class="sst" for="stat-smallshield">SHOW ITEM STAT</label>
		<ul class="submenu">
