<label class="popbox-BG" for="spikeshield"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="spikeshield"></label>
	<center><p>Spike Shield</p></center>
	<div class="content">
		<input id="stat-spikeshield" type="checkbox" name="menu" />
		<label class="sst" for="stat-spikeshield">SHOW ITEM STAT</label>
		<ul class="submenu">
