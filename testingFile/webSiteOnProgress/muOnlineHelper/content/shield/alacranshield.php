<label class="popbox-BG" for="alacranshield"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="alacranshield"></label>
	<center><p>Alacran Shield</p></center>
	<div class="content">
		<input id="stat-alacranshield" type="checkbox" name="menu" />
		<label class="sst" for="stat-alacranshield">SHOW ITEM STAT</label>
		<ul class="submenu">
