<label class="popbox-BG" for="magicknight"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="magicknight"></label>
	<center><p>Magic Knight</p></center>
	<div class="content">
		<input id="stat-magicknight" type="checkbox" name="menu" />
		<label class="sst" for="stat-magicknight">SHOW ITEM STAT</label>
		<ul class="submenu">
