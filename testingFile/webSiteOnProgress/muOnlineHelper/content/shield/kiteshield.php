<label class="popbox-BG" for="kiteshield"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="kiteshield"></label>
	<center><p>Kite Shield</p></center>
	<div class="content">
		<input id="stat-kiteshield" type="checkbox" name="menu" />
		<label class="sst" for="stat-kiteshield">SHOW ITEM STAT</label>
		<ul class="submenu">
