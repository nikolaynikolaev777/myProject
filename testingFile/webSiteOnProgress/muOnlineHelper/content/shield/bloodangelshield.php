<label class="popbox-BG" for="bloodangelshield"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="bloodangelshield"></label>
	<center><p>Bloodangel Shield</p></center>
	<div class="content">
		<input id="stat-bloodangelshield" type="checkbox" name="menu" />
		<label class="sst" for="stat-bloodangelshield">SHOW ITEM STAT</label>
		<ul class="submenu">
