<label class="popbox-BG" for="soulshield"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="soulshield"></label>
	<center><p>Soul Shield</p></center>
	<div class="content">
		<input id="stat-soulshield" type="checkbox" name="menu" />
		<label class="sst" for="stat-soulshield">SHOW ITEM STAT</label>
		<ul class="submenu">
