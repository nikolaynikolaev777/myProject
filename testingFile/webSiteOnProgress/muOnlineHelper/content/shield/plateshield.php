<label class="popbox-BG" for="plateshield"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="plateshield"></label>
	<center><p>Plate Shield</p></center>
	<div class="content">
		<input id="stat-plateshield" type="checkbox" name="menu" />
		<label class="sst" for="stat-plateshield">SHOW ITEM STAT</label>
		<ul class="submenu">
