<label class="popbox-BG" for="elementalshield"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="elementalshield"></label>
	<center><p>Elemental Shield</p></center>
	<div class="content">
		<input id="stat-elementalshield" type="checkbox" name="menu" />
		<label class="sst" for="stat-elementalshield">SHOW ITEM STAT</label>
		<ul class="submenu">
