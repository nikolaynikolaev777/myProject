<label class="popbox-BG" for="dragonslayershield"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="dragonslayershield"></label>
	<center><p>Dragon Slayer Shield</p></center>
	<div class="content">
		<input id="stat-dragonslayershield" type="checkbox" name="menu" />
		<label class="sst" for="stat-dragonslayershield">SHOW ITEM STAT</label>
		<ul class="submenu">
