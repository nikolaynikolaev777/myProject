<label class="popbox-BG" for="holyangelstaff"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="holyangelstaff"></label>
	<center><p>Holyangel Staff</p></center>
	<div class="content">
		<input id="stat-holyangelstaff" type="checkbox" name="menu" />
		<label class="sst" for="stat-holyangelstaff">SHOW ITEM STAT</label>
		<ul class="submenu">
