<label class="popbox-BG" for="soulstaff"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="soulstaff"></label>
	<center><p>Soul Staff</p></center>
	<div class="content">
		<input id="stat-soulstaff" type="checkbox" name="menu" />
		<label class="sst" for="stat-soulstaff">SHOW ITEM STAT</label>
		<ul class="submenu">
