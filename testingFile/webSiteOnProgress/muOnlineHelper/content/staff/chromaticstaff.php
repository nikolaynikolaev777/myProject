<label class="popbox-BG" for="chromaticstaff"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="chromaticstaff"></label>
	<center><p>Chromatic Staff</p></center>
	<div class="content">
		<input id="stat-chromaticstaff" type="checkbox" name="menu" />
		<label class="sst" for="stat-chromaticstaff">SHOW ITEM STAT</label>
		<ul class="submenu">
