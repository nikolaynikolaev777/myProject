<label class="popbox-BG" for="staffofdestruction"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="staffofdestruction"></label>
	<center><p>Staff of Destruction</p></center>
	<div class="content">
		<input id="stat-staffofdestruction" type="checkbox" name="menu" />
		<label class="sst" for="stat-staffofdestruction">SHOW ITEM STAT</label>
		<ul class="submenu">
