<label class="popbox-BG" for="staffofthearchangel"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="staffofthearchangel"></label>
	<center><p>Staff of the Archangel</p></center>
	<div class="content">
		<input id="stat-staffofthearchangel" type="checkbox" name="menu" />
		<label class="sst" for="stat-staffofthearchangel">SHOW ITEM STAT</label>
		<ul class="submenu">
