<label class="popbox-BG" for="chaoslightingstaff"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="chaoslightingstaff"></label>
	<center><p>Chaos Lighting Staff</p></center>
	<div class="content">
		<input id="stat-chaoslightingstaff" type="checkbox" name="menu" />
		<label class="sst" for="stat-chaoslightingstaff">SHOW ITEM STAT</label>
		<ul class="submenu">
