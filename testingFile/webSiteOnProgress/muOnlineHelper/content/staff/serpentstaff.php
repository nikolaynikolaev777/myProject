<label class="popbox-BG" for="serpentstaff"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="serpentstaff"></label>
	<center><p>Serpent Staff</p></center>
	<div class="content">
		<input id="stat-serpentstaff" type="checkbox" name="menu" />
		<label class="sst" for="stat-serpentstaff">SHOW ITEM STAT</label>
		<ul class="submenu">
