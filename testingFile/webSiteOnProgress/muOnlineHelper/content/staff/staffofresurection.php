<label class="popbox-BG" for="staffofresurection"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="staffofresurection"></label>
	<center><p>Staff of Resurection</p></center>
	<div class="content">
		<input id="stat-staffofresurection" type="checkbox" name="menu" />
		<label class="sst" for="stat-staffofresurection">SHOW ITEM STAT</label>
		<ul class="submenu">
