<label class="popbox-BG" for="darkangelstaff"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="darkangelstaff"></label>
	<center><p>Darkangel Staff</p></center>
	<div class="content">
		<input id="stat-darkangelstaff" type="checkbox" name="menu" />
		<label class="sst" for="stat-darkangelstaff">SHOW ITEM STAT</label>
		<ul class="submenu">
