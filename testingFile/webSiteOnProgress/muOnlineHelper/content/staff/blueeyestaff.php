<label class="popbox-BG" for="blueeyestaff"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="blueeyestaff"></label>
	<center><p>Blue Eye Staff</p></center>
	<div class="content">
		<input id="stat-blueeyestaff" type="checkbox" name="menu" />
		<label class="sst" for="stat-blueeyestaff">SHOW ITEM STAT</label>
		<ul class="submenu">
