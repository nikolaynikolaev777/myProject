<label class="popbox-BG" for="kundunstaff"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="kundunstaff"></label>
	<center><p>Kundun Staff</p></center>
	<div class="content">
		<input id="stat-kundunstaff" type="checkbox" name="menu" />
		<label class="sst" for="stat-kundunstaff">SHOW ITEM STAT</label>
		<ul class="submenu">
