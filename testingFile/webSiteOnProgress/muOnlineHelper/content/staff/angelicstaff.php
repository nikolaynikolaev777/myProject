<label class="popbox-BG" for="angelicstaff"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="angelicstaff"></label>
	<center><p>Angelic Staff</p></center>
	<div class="content">
		<input id="stat-angelicstaff" type="checkbox" name="menu" />
		<label class="sst" for="stat-angelicstaff">SHOW ITEM STAT</label>
		<ul class="submenu">
