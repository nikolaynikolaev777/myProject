<label class="popbox-BG" for="imberialstaff"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="imberialstaff"></label>
	<center><p>Imberial Staff</p></center>
	<div class="content">
		<input id="stat-imberialstaff" type="checkbox" name="menu" />
		<label class="sst" for="stat-imberialstaff">SHOW ITEM STAT</label>
		<ul class="submenu">
