<label class="popbox-BG" for="dragonsoulstaff"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="dragonsoulstaff"></label>
	<center><p>Dragon Soul Staff</p></center>
	<div class="content">
		<input id="stat-dragonsoulstaff" type="checkbox" name="menu" />
		<label class="sst" for="stat-dragonsoulstaff">SHOW ITEM STAT</label>
		<ul class="submenu">
