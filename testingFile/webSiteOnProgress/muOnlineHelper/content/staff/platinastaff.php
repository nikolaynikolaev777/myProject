<label class="popbox-BG" for="platinastaff"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="platinastaff"></label>
	<center><p>Platina Staff</p></center>
	<div class="content">
		<input id="stat-platinastaff" type="checkbox" name="menu" />
		<label class="sst" for="stat-platinastaff">SHOW ITEM STAT</label>
		<ul class="submenu">
