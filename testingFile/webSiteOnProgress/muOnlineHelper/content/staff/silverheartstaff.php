<label class="popbox-BG" for="silverheartstaff"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="silverheartstaff"></label>
	<center><p>Silver Heart Staff</p></center>
	<div class="content">
		<input id="stat-silverheartstaff" type="checkbox" name="menu" />
		<label class="sst" for="stat-silverheartstaff">SHOW ITEM STAT</label>
		<ul class="submenu">
