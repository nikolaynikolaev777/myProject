<label class="popbox-BG" for="thunderstaff"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="thunderstaff"></label>
	<center><p>Thunder Staff</p></center>
	<div class="content">
		<input id="stat-thunderstaff" type="checkbox" name="menu" />
		<label class="sst" for="stat-thunderstaff">SHOW ITEM STAT</label>
		<ul class="submenu">
