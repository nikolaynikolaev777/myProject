<label class="popbox-BG" for="spitestaff"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="spitestaff"></label>
	<center><p>Spite Staff</p></center>
	<div class="content">
		<input id="stat-spitestaff" type="checkbox" name="menu" />
		<label class="sst" for="stat-spitestaff">SHOW ITEM STAT</label>
		<ul class="submenu">
