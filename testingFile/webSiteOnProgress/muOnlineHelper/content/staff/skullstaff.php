<label class="popbox-BG" for="skullstaff"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="skullstaff"></label>
	<center><p>Skull Staff</p></center>
	<div class="content">
		<input id="stat-skullstaff" type="checkbox" name="menu" />
		<label class="sst" for="stat-skullstaff">SHOW ITEM STAT</label>
		<ul class="submenu">
