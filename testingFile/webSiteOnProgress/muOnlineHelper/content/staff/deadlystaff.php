<label class="popbox-BG" for="deadlystaff"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="deadlystaff"></label>
	<center><p>Deadly Staff</p></center>
	<div class="content">
		<input id="stat-deadlystaff" type="checkbox" name="menu" />
		<label class="sst" for="stat-deadlystaff">SHOW ITEM STAT</label>
		<ul class="submenu">
