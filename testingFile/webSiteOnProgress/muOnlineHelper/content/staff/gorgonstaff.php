<label class="popbox-BG" for="gorgonstaff"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="gorgonstaff"></label>
	<center><p>Gorgon Staff</p></center>
	<div class="content">
		<input id="stat-gorgonstaff" type="checkbox" name="menu" />
		<label class="sst" for="stat-gorgonstaff">SHOW ITEM STAT</label>
		<ul class="submenu">
