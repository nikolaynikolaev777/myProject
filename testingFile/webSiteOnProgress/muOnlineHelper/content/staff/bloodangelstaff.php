<label class="popbox-BG" for="bloodangelstaff"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="bloodangelstaff"></label>
	<center><p>Bloodangel Staff</p></center>
	<div class="content">
		<input id="stat-bloodangelstaff" type="checkbox" name="menu" />
		<label class="sst" for="stat-bloodangelstaff">SHOW ITEM STAT</label>
		<ul class="submenu">
