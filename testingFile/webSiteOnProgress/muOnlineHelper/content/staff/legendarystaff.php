<label class="popbox-BG" for="legendarystaff"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="legendarystaff"></label>
	<center><p>Legendary Staff</p></center>
	<div class="content">
		<input id="stat-legendarystaff" type="checkbox" name="menu" />
		<label class="sst" for="stat-legendarystaff">SHOW ITEM STAT</label>
		<ul class="submenu">
