<label class="popbox-BG" for="miraclestaff"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="miraclestaff"></label>
	<center><p>Miracle Staff</p></center>
	<div class="content">
		<input id="stat-miraclestaff" type="checkbox" name="menu" />
		<label class="sst" for="stat-miraclestaff">SHOW ITEM STAT</label>
		<ul class="submenu">
