<label class="popbox-BG" for="grandviperstaff"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="grandviperstaff"></label>
	<center><p>Grand Viper Staff</p></center>
	<div class="content">
		<input id="stat-grandviperstaff" type="checkbox" name="menu" />
		<label class="sst" for="stat-grandviperstaff">SHOW ITEM STAT</label>
		<ul class="submenu">
