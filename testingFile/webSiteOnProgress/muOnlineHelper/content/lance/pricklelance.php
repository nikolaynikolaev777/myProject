<label class="popbox-BG" for="pricklelance"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="pricklelance"></label>
	<center><p>Prickle Lance</p></center>
	<div class="content">
		<input id="stat-pricklelance" type="checkbox" name="menu" />
		<label class="sst" for="stat-pricklelance">SHOW ITEM STAT</label>
		<ul class="submenu">
