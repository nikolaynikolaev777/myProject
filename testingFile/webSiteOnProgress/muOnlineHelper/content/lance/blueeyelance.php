<label class="popbox-BG" for="blueeyelance"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="blueeyelance"></label>
	<center><p>Blue Eye Lance</p></center>
	<div class="content">
		<input id="stat-blueeyelance" type="checkbox" name="menu" />
		<label class="sst" for="stat-blueeyelance">SHOW ITEM STAT</label>
		<ul class="submenu">
