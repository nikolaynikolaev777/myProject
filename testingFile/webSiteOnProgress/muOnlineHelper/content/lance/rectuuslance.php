<label class="popbox-BG" for="rectuuslance"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="rectuuslance"></label>
	<center><p>Rectuus Lance</p></center>
	<div class="content">
		<input id="stat-rectuuslance" type="checkbox" name="menu" />
		<label class="sst" for="stat-rectuuslance">SHOW ITEM STAT</label>
		<ul class="submenu">
