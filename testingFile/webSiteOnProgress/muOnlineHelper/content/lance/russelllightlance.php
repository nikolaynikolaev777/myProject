<label class="popbox-BG" for="russelllightlance"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="russelllightlance"></label>
	<center><p>Russell Light Lance</p></center>
	<div class="content">
		<input id="stat-russelllightlance" type="checkbox" name="menu" />
		<label class="sst" for="stat-russelllightlance">SHOW ITEM STAT</label>
		<ul class="submenu">
