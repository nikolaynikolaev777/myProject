<label class="popbox-BG" for="darkangellance"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="darkangellance"></label>
	<center><p>Darkangel Lance</p></center>
	<div class="content">
		<input id="stat-darkangellance" type="checkbox" name="menu" />
		<label class="sst" for="stat-darkangellance">SHOW ITEM STAT</label>
		<ul class="submenu">
