<label class="popbox-BG" for="soullance"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="soullance"></label>
	<center><p>Soul Lance</p></center>
	<div class="content">
		<input id="stat-soullance" type="checkbox" name="menu" />
		<label class="sst" for="stat-soullance">SHOW ITEM STAT</label>
		<ul class="submenu">
