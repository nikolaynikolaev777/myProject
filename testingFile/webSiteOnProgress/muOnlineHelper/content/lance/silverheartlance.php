<label class="popbox-BG" for="silverheartlance"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="silverheartlance"></label>
	<center><p>Silver Heart Lance</p></center>
	<div class="content">
		<input id="stat-silverheartlance" type="checkbox" name="menu" />
		<label class="sst" for="stat-silverheartlance">SHOW ITEM STAT</label>
		<ul class="submenu">
