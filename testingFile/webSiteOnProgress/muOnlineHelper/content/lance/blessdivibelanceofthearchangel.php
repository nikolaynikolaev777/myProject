<label class="popbox-BG" for="blessdivibelanceofthearchangel"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="blessdivibelanceofthearchangel"></label>
	<center><p>Bless Divibe Lance of the Archangel</p></center>
	<div class="content">
		<input id="stat-blessdivibelanceofthearchangel" type="checkbox" name="menu" />
		<label class="sst" for="stat-blessdivibelanceofthearchangel">SHOW ITEM STAT</label>
		<ul class="submenu">
