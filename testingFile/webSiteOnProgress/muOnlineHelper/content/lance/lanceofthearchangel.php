<label class="popbox-BG" for="lanceofthearchangel"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="lanceofthearchangel"></label>
	<center><p>Lance of the Archangel</p></center>
	<div class="content">
		<input id="stat-lanceofthearchangel" type="checkbox" name="menu" />
		<label class="sst" for="stat-lanceofthearchangel">SHOW ITEM STAT</label>
		<ul class="submenu">
