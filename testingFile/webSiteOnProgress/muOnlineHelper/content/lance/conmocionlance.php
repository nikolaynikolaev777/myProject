<label class="popbox-BG" for="conmocionlance"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="conmocionlance"></label>
	<center><p>Conmocion Lance</p></center>
	<div class="content">
		<input id="stat-conmocionlance" type="checkbox" name="menu" />
		<label class="sst" for="stat-conmocionlance">SHOW ITEM STAT</label>
		<ul class="submenu">
