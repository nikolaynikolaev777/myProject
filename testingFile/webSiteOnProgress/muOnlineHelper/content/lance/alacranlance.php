<label class="popbox-BG" for="alacranlance"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="alacranlance"></label>
	<center><p>Alacran Lance</p></center>
	<div class="content">
		<input id="stat-alacranlance" type="checkbox" name="menu" />
		<label class="sst" for="stat-alacranlance">SHOW ITEM STAT</label>
		<ul class="submenu">
