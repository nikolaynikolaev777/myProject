<label class="popbox-BG" for="lapidlance"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="lapidlance"></label>
	<center><p>Lapid Lance</p></center>
	<div class="content">
		<input id="stat-lapidlance" type="checkbox" name="menu" />
		<label class="sst" for="stat-lapidlance">SHOW ITEM STAT</label>
		<ul class="submenu">
