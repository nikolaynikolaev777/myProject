<label class="popbox-BG" for="bloodangellance"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="bloodangellance"></label>
	<center><p>Bloodangel Lance</p></center>
	<div class="content">
		<input id="stat-bloodangellance" type="checkbox" name="menu" />
		<label class="sst" for="stat-bloodangellance">SHOW ITEM STAT</label>
		<ul class="submenu">
