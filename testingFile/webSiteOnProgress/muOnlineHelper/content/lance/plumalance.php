<label class="popbox-BG" for="plumalance"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="plumalance"></label>
	<center><p>Pluma Lance</p></center>
	<div class="content">
		<input id="stat-plumalance" type="checkbox" name="menu" />
		<label class="sst" for="stat-plumalance">SHOW ITEM STAT</label>
		<ul class="submenu">
