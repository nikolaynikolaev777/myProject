<label class="popbox-BG" for="vislance"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="vislance"></label>
	<center><p>Vis Lance</p></center>
	<div class="content">
		<input id="stat-vislance" type="checkbox" name="menu" />
		<label class="sst" for="stat-vislance">SHOW ITEM STAT</label>
		<ul class="submenu">
