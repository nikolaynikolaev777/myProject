<label class="popbox-BG" for="silverheartmagicsword"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="silverheartmagicsword"></label>
	<center><p>Silver Heart Magic Sword</p></center>
	<div class="content">
