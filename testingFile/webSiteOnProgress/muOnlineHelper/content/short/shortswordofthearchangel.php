<label class="popbox-BG" for="shortswordofthearchangel"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="shortswordofthearchangel"></label>
	<center><p>Short Sword of the Archangel</p></center>
	<div class="content">
		<input id="stat-shortswordofthearchangel" type="checkbox" name="menu" />
		<label class="sst" for="stat-shortswordofthearchangel">SHOW ITEM STAT</label>
		<ul class="submenu">
