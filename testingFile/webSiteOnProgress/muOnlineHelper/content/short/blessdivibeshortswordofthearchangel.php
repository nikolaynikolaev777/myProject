<label class="popbox-BG" for="blessdivibeshortswordofthearchangel"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="blessdivibeshortswordofthearchangel"></label>
	<center><p>Bless Divibe Short Sword of the Archangel</p></center>
	<div class="content">
		<input id="stat-blessdivibeshortswordofthearchangel" type="checkbox" name="menu" />
		<label class="sst" for="stat-blessdivibeshortswordofthearchangel">SHOW ITEM STAT</label>
		<ul class="submenu">
		...
		<table class="tbconwidth">
			<tbody>
				<tr>
					...
					<td colspan="2" bgcolor="EFEC50"><div align="center">Normal</div></td>
					<td colspan="2" bgcolor="DF5326"><div align="center">Normal Requires</div></td>
					<td colspan="2" bgcolor="A2DA3F"><div align="center">Excellent</div></td>
					<td colspan="2" bgcolor="DF5326"><div align="center">Excellent Requires</div></td>
				</tr>
				<tr>
					<td bgcolor="8083AF"></td>
					<td bgcolor="D8C935"><div align="center">Min</div></td>
					<td bgcolor="D8C935"><div align="center">Max</div></td>
					<td bgcolor="B24D2C"><div align="center">Stenght</div></td>
					<td bgcolor="B24D2C"><div align="center">Agility</div></td>
					<td bgcolor="83BF32"><div align="center">Min</div></td>
					<td bgcolor="83BF32"><div align="center">Max</div></td>
					<td bgcolor="B24D2C"><div align="center">Strenght</div></td>
					<td bgcolor="B24D2C"><div align="center">Agility</div></td>
				</tr>
