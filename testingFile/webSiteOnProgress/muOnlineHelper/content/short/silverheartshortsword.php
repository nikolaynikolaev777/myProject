<label class="popbox-BG" for="silverheartshortsword"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="silverheartshortsword"></label>
	<center><p>Silver Heart Short Sword</p></center>
	<div class="content">
		<input id="stat-silverheartshortsword" type="checkbox" name="menu" />
		<label class="sst" for="stat-silverheartshortsword">SHOW ITEM STAT</label>
		<ul class="submenu">
