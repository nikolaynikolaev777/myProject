<label class="popbox-BG" for="paringshortsword"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="paringshortsword"></label>
	<center><p>Paring Short Sword</p></center>
	<div class="content">
		<input id="stat-paringshortsword" type="checkbox" name="menu" />
		<label class="sst" for="stat-paringshortsword">SHOW ITEM STAT</label>
		<ul class="submenu">
