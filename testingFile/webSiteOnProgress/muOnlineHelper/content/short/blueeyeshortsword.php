<label class="popbox-BG" for="blueeyeshortsword"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="blueeyeshortsword"></label>
	<center><p>Blue Eye Short Sword</p></center>
	<div class="content">
		<input id="stat-blueeyeshortsword" type="checkbox" name="menu" />
		<label class="sst" for="stat-blueeyeshortsword">SHOW ITEM STAT</label>
		<ul class="submenu">
