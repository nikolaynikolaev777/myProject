<label class="popbox-BG" for="cookeryshortsword"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="cookeryshortsword"></label>
	<center><p>Cookery Short Sword</p></center>
	<div class="content">
		<input id="stat-cookeryshortsword" type="checkbox" name="menu" />
		<label class="sst" for="stat-cookeryshortsword">SHOW ITEM STAT</label>
		<ul class="submenu">
