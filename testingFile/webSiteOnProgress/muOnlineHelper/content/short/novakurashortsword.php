<label class="popbox-BG" for="novakurashortsword"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="novakurashortsword"></label>
	<center><p>Novakura Short Sword</p></center>
	<div class="content">
		<input id="stat-novakurashortsword" type="checkbox" name="menu" />
		<label class="sst" for="stat-novakurashortsword">SHOW ITEM STAT</label>
		<ul class="submenu">
