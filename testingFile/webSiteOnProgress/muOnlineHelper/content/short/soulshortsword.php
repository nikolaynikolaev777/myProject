<label class="popbox-BG" for="soulshortsword"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="soulshortsword"></label>
	<center><p>Soul Short Sword</p></center>
	<div class="content">
		<input id="stat-soulshortsword" type="checkbox" name="menu" />
		<label class="sst" for="stat-soulshortsword">SHOW ITEM STAT</label>
		<ul class="submenu">
