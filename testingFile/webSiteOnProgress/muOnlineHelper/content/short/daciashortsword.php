<label class="popbox-BG" for="daciashortsword"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="daciashortsword"></label>
	<center><p>Dacia Short Sword</p></center>
	<div class="content">
		<input id="stat-daciashortsword" type="checkbox" name="menu" />
		<label class="sst" for="stat-daciashortsword">SHOW ITEM STAT</label>
		<ul class="submenu">
