<label class="popbox-BG" for="flatshortsword"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="flatshortsword"></label>
	<center><p>Flat Short Sword</p></center>
	<div class="content">
		<input id="stat-flatshortsword" type="checkbox" name="menu" />
		<label class="sst" for="stat-flatshortsword">SHOW ITEM STAT</label>
		<ul class="submenu">
