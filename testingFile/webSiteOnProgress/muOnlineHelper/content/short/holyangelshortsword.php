<label class="popbox-BG" for="holyangelshortsword"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="holyangelshortsword"></label>
	<center><p>Holyangel Short Sword</p></center>
	<div class="content">
		<input id="stat-holyangelshortsword" type="checkbox" name="menu" />
		<label class="sst" for="stat-holyangelshortsword">SHOW ITEM STAT</label>
		<ul class="submenu">
