<label class="popbox-BG" for="bloodangelshortsword"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="bloodangelshortsword"></label>
	<center><p>Bloodangel Short Sword</p></center>
	<div class="content">
		<input id="stat-bloodangelshortsword" type="checkbox" name="menu" />
		<label class="sst" for="stat-bloodangelshortsword">SHOW ITEM STAT</label>
		<ul class="submenu">
