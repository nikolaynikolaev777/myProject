<label class="popbox-BG" for="darkangelshortsword"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="darkangelshortsword"></label>
	<center><p>Darkangel Short Sword</p></center>
	<div class="content">
		<input id="stat-darkangelshortsword" type="checkbox" name="menu" />
		<label class="sst" for="stat-darkangelshortsword">SHOW ITEM STAT</label>
		<ul class="submenu">
