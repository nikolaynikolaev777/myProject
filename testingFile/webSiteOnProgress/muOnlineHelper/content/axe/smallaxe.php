<label class="popbox-BG" for="smallaxe"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="smallaxe"></label>
	<center><p>Small Axe</p></center>
	<div class="content">
		<input id="stat-smallaxe" type="checkbox" name="menu" />
		<label class="sst" for="stat-smallaxe">SHOW ITEM STAT</label>
		<ul class="submenu">
