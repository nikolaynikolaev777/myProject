<label class="popbox-BG" for="greatlordscepter"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="greatlordscepter"></label>
	<center><p>Great Lord Scepter</p></center>
	<div class="content">
		<input id="stat-greatlordscepter" type="checkbox" name="menu" />
		<label class="sst" for="stat-greatlordscepter">SHOW ITEM STAT</label>
		<ul class="submenu">
