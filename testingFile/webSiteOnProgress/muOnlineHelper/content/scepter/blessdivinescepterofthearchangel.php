<label class="popbox-BG" for="blessdivinescepterofthearchangel"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="blessdivinescepterofthearchangel"></label>
	<center><p>Bless Divine Scepter of the Archangel</p></center>
	<div class="content">
		<input id="stat-blessdivinescepterofthearchangel" type="checkbox" name="menu" />
		<label class="sst" for="stat-blessdivinescepterofthearchangel">SHOW ITEM STAT</label>
		<ul class="submenu">
