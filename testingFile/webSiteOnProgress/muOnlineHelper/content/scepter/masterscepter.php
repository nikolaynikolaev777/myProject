<label class="popbox-BG" for="masterscepter"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="masterscepter"></label>
	<center><p>Master Scepter</p></center>
	<div class="content">
		<input id="stat-masterscepter" type="checkbox" name="menu" />
		<label class="sst" for="stat-masterscepter">SHOW ITEM STAT</label>
		<ul class="submenu">
