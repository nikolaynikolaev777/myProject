<label class="popbox-BG" for="strikerscepter"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="strikerscepter"></label>
	<center><p>Striker Scepter</p></center>
	<div class="content">
		<input id="stat-strikerscepter" type="checkbox" name="menu" />
		<label class="sst" for="stat-strikerscepter">SHOW ITEM STAT</label>
		<ul class="submenu">
