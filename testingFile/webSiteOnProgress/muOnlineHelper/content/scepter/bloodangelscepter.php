<label class="popbox-BG" for="bloodangelscepter"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="bloodangelscepter"></label>
	<center><p>Bloodangel Scepter</p></center>
	<div class="content">
		<input id="stat-bloodangelscepter" type="checkbox" name="menu" />
		<label class="sst" for="stat-bloodangelscepter">SHOW ITEM STAT</label>
		<ul class="submenu">
