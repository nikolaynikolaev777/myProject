<label class="popbox-BG" for="holyangelscepter"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="holyangelscepter"></label>
	<center><p>Holyangel Scepter</p></center>
	<div class="content">
		<input id="stat-holyangelscepter" type="checkbox" name="menu" />
		<label class="sst" for="stat-holyangelscepter">SHOW ITEM STAT</label>
		<ul class="submenu">
