<label class="popbox-BG" for="silverheartscepter"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="silverheartscepter"></label>
	<center><p>Silver Heart Scepter</p></center>
	<div class="content">
		<input id="stat-silverheartscepter" type="checkbox" name="menu" />
		<label class="sst" for="stat-silverheartscepter">SHOW ITEM STAT</label>
		<ul class="submenu">
