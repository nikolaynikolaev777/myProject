<label class="popbox-BG" for="darkangelscepter"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="darkangelscepter"></label>
	<center><p>Darkangel Scepter</p></center>
	<div class="content">
		<input id="stat-darkangelscepter" type="checkbox" name="menu" />
		<label class="sst" for="stat-darkangelscepter">SHOW ITEM STAT</label>
		<ul class="submenu">
