<label class="popbox-BG" for="battlescepter"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="battlescepter"></label>
	<center><p>Battle Scepter</p></center>
	<div class="content">
		<input id="stat-battlescepter" type="checkbox" name="menu" />
		<label class="sst" for="stat-battlescepter">SHOW ITEM STAT</label>
		<ul class="submenu">
