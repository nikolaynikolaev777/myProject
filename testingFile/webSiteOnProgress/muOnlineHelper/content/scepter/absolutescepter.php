<label class="popbox-BG" for="absolutescepter"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="absolutescepter"></label>
	<center><p>Absolute Scepter</p></center>
	<div class="content">
		<input id="stat-absolutescepter" type="checkbox" name="menu" />
		<label class="sst" for="stat-absolutescepter">SHOW ITEM STAT</label>
		<ul class="submenu">
