<label class="popbox-BG" for="shiningscepter"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="shiningscepter"></label>
	<center><p>Shining Scepter</p></center>
	<div class="content">
		<input id="stat-shiningscepter" type="checkbox" name="menu" />
		<label class="sst" for="stat-shiningscepter">SHOW ITEM STAT</label>
		<ul class="submenu">
