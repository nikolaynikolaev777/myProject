<label class="popbox-BG" for="lordscepter"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="lordscepter"></label>
	<center><p>Lord Scepter</p></center>
	<div class="content">
		<input id="stat-lordscepter" type="checkbox" name="menu" />
		<label class="sst" for="stat-lordscepter">SHOW ITEM STAT</label>
		<ul class="submenu">
