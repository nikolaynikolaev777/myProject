<label class="popbox-BG" for="blueeyescepter"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="blueeyescepter"></label>
	<center><p>Blue Eye Scepter</p></center>
	<div class="content">
		<input id="stat-blueeyescepter" type="checkbox" name="menu" />
		<label class="sst" for="stat-blueeyescepter">SHOW ITEM STAT</label>
		<ul class="submenu">
