<label class="popbox-BG" for="scepterofthearchangel"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="scepterofthearchangel"></label>
	<center><p>Scepter of the Archangel</p></center>
	<div class="content">
		<input id="stat-scepterofthearchangel" type="checkbox" name="menu" />
		<label class="sst" for="stat-scepterofthearchangel">SHOW ITEM STAT</label>
		<ul class="submenu">
