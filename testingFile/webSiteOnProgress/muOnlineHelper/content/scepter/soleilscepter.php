<label class="popbox-BG" for="soleilscepter"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="soleilscepter"></label>
	<center><p>Soleil Scepter</p></center>
	<div class="content">
		<input id="stat-soleilscepter" type="checkbox" name="menu" />
		<label class="sst" for="stat-soleilscepter">SHOW ITEM STAT</label>
		<ul class="submenu">
