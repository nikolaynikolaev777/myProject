<label class="popbox-BG" for="soulscepter"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="soulscepter"></label>
	<center><p>Soul Scepter</p></center>
	<div class="content">
		<input id="stat-soulscepter" type="checkbox" name="menu" />
		<label class="sst" for="stat-soulscepter">SHOW ITEM STAT</label>
		<ul class="submenu">
