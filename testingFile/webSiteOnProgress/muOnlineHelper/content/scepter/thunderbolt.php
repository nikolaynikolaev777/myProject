<label class="popbox-BG" for="thunderbolt"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="thunderbolt"></label>
	<center><p>Thunderbolt</p></center>
	<div class="content">
		<input id="stat-thunderbolt" type="checkbox" name="menu" />
		<label class="sst" for="stat-thunderbolt">SHOW ITEM STAT</label>
		<ul class="submenu">
