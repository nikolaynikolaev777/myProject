<label class="popbox-BG" for="greatscepter"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="greatscepter"></label>
	<center><p>Great Scepter</p></center>
	<div class="content">
		<input id="stat-greatscepter" type="checkbox" name="menu" />
		<label class="sst" for="stat-greatscepter">SHOW ITEM STAT</label>
		<ul class="submenu">
