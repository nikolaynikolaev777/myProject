<label class="popbox-BG" for="devastclaw"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="devastclaw"></label>
	<center><p>Devast Claw</p></center>
	<div class="content">
		<input id="stat-devastclaw" type="checkbox" name="menu" />
		<label class="sst" for="stat-devastclaw">SHOW ITEM STAT</label>
		<ul class="submenu">
