<label class="popbox-BG" for="blueeyeclaw"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="blueeyeclaw"></label>
	<center><p>Blue Eye Claw</p></center>
	<div class="content">
		<input id="stat-blueeyeclaw" type="checkbox" name="menu" />
		<label class="sst" for="stat-blueeyeclaw">SHOW ITEM STAT</label>
		<ul class="submenu">
