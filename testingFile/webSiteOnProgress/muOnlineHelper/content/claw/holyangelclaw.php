<label class="popbox-BG" for="holyangelclaw"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="holyangelclaw"></label>
	<center><p>Holyangel Claw</p></center>
	<div class="content">
		<input id="stat-holyangelclaw" type="checkbox" name="menu" />
		<label class="sst" for="stat-holyangelclaw">SHOW ITEM STAT</label>
		<ul class="submenu">
