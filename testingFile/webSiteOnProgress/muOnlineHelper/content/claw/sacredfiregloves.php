<label class="popbox-BG" for="sacredfiregloves"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="sacredfiregloves"></label>
	<center><p>Sacred Fire Gloves</p></center>
	<div class="content">
		<input id="stat-sacredfiregloves" type="checkbox" name="menu" />
		<label class="sst" for="stat-sacredfiregloves">SHOW ITEM STAT</label>
		<ul class="submenu">
