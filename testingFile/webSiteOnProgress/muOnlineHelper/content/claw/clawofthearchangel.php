<label class="popbox-BG" for="clawofthearchangel"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="clawofthearchangel"></label>
	<center><p>Claw of the Archangel</p></center>
	<div class="content">
		<input id="stat-clawofthearchangel" type="checkbox" name="menu" />
		<label class="sst" for="stat-clawofthearchangel">SHOW ITEM STAT</label>
		<ul class="submenu">
