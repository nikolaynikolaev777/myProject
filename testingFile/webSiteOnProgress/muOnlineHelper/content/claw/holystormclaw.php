<label class="popbox-BG" for="holystormclaw"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="holystormclaw"></label>
	<center><p>Holy Storm Claw</p></center>
	<div class="content">
		<input id="stat-holystormclaw" type="checkbox" name="menu" />
		<label class="sst" for="stat-holystormclaw">SHOW ITEM STAT</label>
		<ul class="submenu">
