<label class="popbox-BG" for="phoenixsoulclaw"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="phoenixsoulclaw"></label>
	<center><p>Phoenix Soul Claw</p></center>
	<div class="content">
		<input id="stat-phoenixsoulclaw" type="checkbox" name="menu" />
		<label class="sst" for="stat-phoenixsoulclaw">SHOW ITEM STAT</label>
		<ul class="submenu">
