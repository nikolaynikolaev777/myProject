<label class="popbox-BG" for="blooangelclaw"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="blooangelclaw"></label>
	<center><p>Blooangel Claw</p></center>
	<div class="content">
		<input id="stat-blooangelclaw" type="checkbox" name="menu" />
		<label class="sst" for="stat-blooangelclaw">SHOW ITEM STAT</label>
		<ul class="submenu">
