<label class="popbox-BG" for="soulclaw"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="soulclaw"></label>
	<center><p>Soul Claw</p></center>
	<div class="content">
		<input id="stat-soulclaw" type="checkbox" name="menu" />
		<label class="sst" for="stat-soulclaw">SHOW ITEM STAT</label>
		<ul class="submenu">
