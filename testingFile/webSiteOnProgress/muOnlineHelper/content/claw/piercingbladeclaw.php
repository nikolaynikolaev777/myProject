<label class="popbox-BG" for="piercingbladeclaw"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="piercingbladeclaw"></label>
	<center><p>Piercing Blade Claw</p></center>
	<div class="content">
		<input id="stat-piercingbladeclaw" type="checkbox" name="menu" />
		<label class="sst" for="stat-piercingbladeclaw">SHOW ITEM STAT</label>
		<ul class="submenu">
