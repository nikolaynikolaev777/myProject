<label class="popbox-BG" for="darkangelclaw"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="darkangelclaw"></label>
	<center><p>Darkangel Claw</p></center>
	<div class="content">
		<input id="stat-darkangelclaw" type="checkbox" name="menu" />
		<label class="sst" for="stat-darkangelclaw">SHOW ITEM STAT</label>
		<ul class="submenu">
