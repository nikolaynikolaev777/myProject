<label class="popbox-BG" for="panteraclaw"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="panteraclaw"></label>
	<center><p>Pantera Claw</p></center>
	<div class="content">
		<input id="stat-panteraclaw" type="checkbox" name="menu" />
		<label class="sst" for="stat-panteraclaw">SHOW ITEM STAT</label>
		<ul class="submenu">
