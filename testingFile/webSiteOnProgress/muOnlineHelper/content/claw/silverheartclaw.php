<label class="popbox-BG" for="silverheartclaw"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="silverheartclaw"></label>
	<center><p>Silver Heart Claw</p></center>
	<div class="content">
		<input id="stat-silverheartclaw" type="checkbox" name="menu" />
		<label class="sst" for="stat-silverheartclaw">SHOW ITEM STAT</label>
		<ul class="submenu">
