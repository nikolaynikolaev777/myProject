<label class="popbox-BG" for="blessdivineclawofthearchangel"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="blessdivineclawofthearchangel"></label>
	<center><p>Bless Divine Claw of the Archangel</p></center>
	<div class="content">
		<input id="stat-blessdivineclawofthearchangel" type="checkbox" name="menu" />
		<label class="sst" for="stat-blessdivineclawofthearchangel">SHOW ITEM STAT</label>
		<ul class="submenu">
