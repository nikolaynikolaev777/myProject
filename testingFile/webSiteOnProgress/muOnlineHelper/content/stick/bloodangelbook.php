<label class="popbox-BG" for="bloodangelbook"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="bloodangelbook"></label>
	<center><p>Bloodangel Book</p></center>
	<div class="content">
		<input id="stat-bloodangelbook" type="checkbox" name="menu" />
		<label class="sst" for="stat-bloodangelbook">SHOW ITEM STAT</label>
		<ul class="submenu">
