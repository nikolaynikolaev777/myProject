<label class="popbox-BG" for="eternalwingsstick"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="eternalwingsstick"></label>
	<center><p>Eternal Wings Stick</p></center>
	<div class="content">
		<input id="stat-eternalwingsstick" type="checkbox" name="menu" />
		<label class="sst" for="stat-eternalwingsstick">SHOW ITEM STAT</label>
		<ul class="submenu">
