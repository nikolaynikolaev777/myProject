<label class="popbox-BG" for="misterystick"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="misterystick"></label>
	<center><p>Mistery Stick</p></center>
	<div class="content">
		<input id="stat-misterystick" type="checkbox" name="menu" />
		<label class="sst" for="stat-misterystick">SHOW ITEM STAT</label>
		<ul class="submenu">
