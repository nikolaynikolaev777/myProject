<label class="popbox-BG" for="stormblitzstick"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="stormblitzstick"></label>
	<center><p>Storm Blitz Stick</p></center>
	<div class="content">
		<input id="stat-stormblitzstick" type="checkbox" name="menu" />
		<label class="sst" for="stat-stormblitzstick">SHOW ITEM STAT</label>
		<ul class="submenu">
