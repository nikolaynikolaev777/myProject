<label class="popbox-BG" for="blueeyebook"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="blueeyebook"></label>
	<center><p>Blue Eye Book</p></center>
	<div class="content">
		<input id="stat-blueeyebook" type="checkbox" name="menu" />
		<label class="sst" for="stat-blueeyebook">SHOW ITEM STAT</label>
		<ul class="submenu">
