<label class="popbox-BG" for="divinestickofthearchangel"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="divinestickofthearchangel"></label>
	<center><p>Divine Stick of the Archangel</p></center>
	<div class="content">
		<input id="stat-divinestickofthearchangel" type="checkbox" name="menu" />
		<label class="sst" for="stat-divinestickofthearchangel">SHOW ITEM STAT</label>
		<ul class="submenu">
