<label class="popbox-BG" for="holyangelbook"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="holyangelbook"></label>
	<center><p>Holyangel Book</p></center>
	<div class="content">
		<input id="stat-holyangelbook" type="checkbox" name="menu" />
		<label class="sst" for="stat-holyangelbook">SHOW ITEM STAT</label>
		<ul class="submenu">
