<label class="popbox-BG" for="darkangelbook"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="darkangelbook"></label>
	<center><p>Darkangel Book</p></center>
	<div class="content">
		<input id="stat-darkangelbook" type="checkbox" name="menu" />
		<label class="sst" for="stat-darkangelbook">SHOW ITEM STAT</label>
		<ul class="submenu">
