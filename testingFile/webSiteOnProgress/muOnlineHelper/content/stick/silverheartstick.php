<label class="popbox-BG" for="silverheartstick"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="silverheartstick"></label>
	<center><p>Silver Heart Stick</p></center>
	<div class="content">
		<input id="stat-silverheartstick" type="checkbox" name="menu" />
		<label class="sst" for="stat-silverheartstick">SHOW ITEM STAT</label>
		<ul class="submenu">
