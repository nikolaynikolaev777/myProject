<label class="popbox-BG" for="demonicstick"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="demonicstick"></label>
	<center><p>Demonic Stick</p></center>
	<div class="content">
		<input id="stat-demonicstick" type="checkbox" name="menu" />
		<label class="sst" for="stat-demonicstick">SHOW ITEM STAT</label>
		<ul class="submenu">
