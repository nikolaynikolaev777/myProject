<label class="popbox-BG" for="summonspiritstick"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="summonspiritstick"></label>
	<center><p>Summon Spirit Stick</p></center>
	<div class="content">
		<input id="stat-summonspiritstick" type="checkbox" name="menu" />
		<label class="sst" for="stat-summonspiritstick">SHOW ITEM STAT</label>
		<ul class="submenu">
