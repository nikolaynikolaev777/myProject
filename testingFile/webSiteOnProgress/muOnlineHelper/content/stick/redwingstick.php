<label class="popbox-BG" for="redwingstick"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="redwingstick"></label>
	<center><p>Red Wing Stick</p></center>
	<div class="content">
		<input id="stat-redwingstick" type="checkbox" name="menu" />
		<label class="sst" for="stat-redwingstick">SHOW ITEM STAT</label>
		<ul class="submenu">
