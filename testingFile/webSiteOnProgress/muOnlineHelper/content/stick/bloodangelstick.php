<label class="popbox-BG" for="bloodangelstick"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="bloodangelstick"></label>
	<center><p>Bloodangel Stick</p></center>
	<div class="content">
		<input id="stat-bloodangelstick" type="checkbox" name="menu" />
		<label class="sst" for="stat-bloodangelstick">SHOW ITEM STAT</label>
		<ul class="submenu">
