<label class="popbox-BG" for="darkangelstick"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="darkangelstick"></label>
	<center><p>Darkangel Stick</p></center>
	<div class="content">
		<input id="stat-darkangelstick" type="checkbox" name="menu" />
		<label class="sst" for="stat-darkangelstick">SHOW ITEM STAT</label>
		<ul class="submenu">
