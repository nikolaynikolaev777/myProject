<label class="popbox-BG" for="holyangelstick"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="holyangelstick"></label>
	<center><p>Holyangel Stick</p></center>
	<div class="content">
		<input id="stat-holyangelstick" type="checkbox" name="menu" />
		<label class="sst" for="stat-holyangelstick">SHOW ITEM STAT</label>
		<ul class="submenu">
