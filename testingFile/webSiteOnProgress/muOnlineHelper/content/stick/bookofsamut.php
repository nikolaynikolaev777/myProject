<label class="popbox-BG" for="bookofsamut"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="bookofsamut"></label>
	<center><p>Book of Samut</p></center>
	<div class="content">
		<input id="stat-bookofsamut" type="checkbox" name="menu" />
		<label class="sst" for="stat-bookofsamut">SHOW ITEM STAT</label>
		<ul class="submenu">
