<label class="popbox-BG" for="ancientstick"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="ancientstick"></label>
	<center><p>Ancient Stick</p></center>
	<div class="content">
		<input id="stat-ancientstick" type="checkbox" name="menu" />
		<label class="sst" for="stat-ancientstick">SHOW ITEM STAT</label>
		<ul class="submenu">
