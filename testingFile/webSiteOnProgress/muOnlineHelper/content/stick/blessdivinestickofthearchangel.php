<label class="popbox-BG" for="blessdivinestickofthearchangel"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="blessdivinestickofthearchangel"></label>
	<center><p>Bless Divine Stick of the Archangel</p></center>
	<div class="content">
		<input id="stat-blessdivinestickofthearchangel" type="checkbox" name="menu" />
		<label class="sst" for="stat-blessdivinestickofthearchangel">SHOW ITEM STAT</label>
		<ul class="submenu">
