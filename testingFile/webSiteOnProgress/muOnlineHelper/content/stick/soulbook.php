<label class="popbox-BG" for="soulbook"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="soulbook"></label>
	<center><p>Soul Book</p></center>
	<div class="content">
		<input id="stat-soulbook" type="checkbox" name="menu" />
		<label class="sst" for="stat-soulbook">SHOW ITEM STAT</label>
		<ul class="submenu">
