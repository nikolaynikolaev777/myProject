<label class="popbox-BG" for="blueeyestick"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="blueeyestick"></label>
	<center><p>Blue Eye Stick</p></center>
	<div class="content">
		<input id="stat-blueeyestick" type="checkbox" name="menu" />
		<label class="sst" for="stat-blueeyestick">SHOW ITEM STAT</label>
		<ul class="submenu">
