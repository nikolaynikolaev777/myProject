<label class="popbox-BG" for="silverheartbook"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="silverheartbook"></label>
	<center><p>Silver Heart Book</p></center>
	<div class="content">
		<input id="stat-silverheartbook" type="checkbox" name="menu" />
		<label class="sst" for="stat-silverheartbook">SHOW ITEM STAT</label>
		<ul class="submenu">
