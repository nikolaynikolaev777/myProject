<label class="popbox-BG" for="bookoflagle"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="bookoflagle"></label>
	<center><p>Book of Lagle</p></center>
	<div class="content">
		<input id="stat-bookoflagle" type="checkbox" name="menu" />
		<label class="sst" for="stat-bookoflagle">SHOW ITEM STAT</label>
		<ul class="submenu">
