<label class="popbox-BG" for="soulstick"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="soulstick"></label>
	<center><p>Soul Stick</p></center>
	<div class="content">
		<input id="stat-soulstick" type="checkbox" name="menu" />
		<label class="sst" for="stat-soulstick">SHOW ITEM STAT</label>
		<ul class="submenu">
