<label class="popbox-BG" for="bookofneil"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="bookofneil"></label>
	<center><p>Book of Neil</p></center>
	<div class="content">
		<input id="stat-bookofneil" type="checkbox" name="menu" />
		<label class="sst" for="stat-bookofneil">SHOW ITEM STAT</label>
		<ul class="submenu">
