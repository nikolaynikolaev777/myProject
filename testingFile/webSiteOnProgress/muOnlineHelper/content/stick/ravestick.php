<label class="popbox-BG" for="ravestick"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="ravestick"></label>
	<center><p>Rave Stick</p></center>
	<div class="content">
		<input id="stat-ravestick" type="checkbox" name="menu" />
		<label class="sst" for="stat-ravestick">SHOW ITEM STAT</label>
		<ul class="submenu">
