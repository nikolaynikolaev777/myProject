<label class="popbox-BG" for="violentwindstick"></label>
<div class="popbox-conn">
	<label class="popbox-close" for="violentwindstick"></label>
	<center><p>Violent Wind Stick</p></center>
	<div class="content">
		<input id="stat-violentwindstick" type="checkbox" name="menu" />
		<label class="sst" for="stat-violentwindstick">SHOW ITEM STAT</label>
		<ul class="submenu">
